<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Asegurate de usar una contraseña larga y dificil de descifrar para mantener tu cuenta segura.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6">
        ...
        <div>
            <x-input-label for="password_confirmation" value="Confirma Nueva Contraseña" />
        ...
        <div class="d-flex align-items-center">
            <x-primary-button class="mt-3">GUARDAR</x-primary-button>
